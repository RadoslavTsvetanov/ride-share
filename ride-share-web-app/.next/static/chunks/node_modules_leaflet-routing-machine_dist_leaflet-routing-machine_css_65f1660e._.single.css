/* [project]/node_modules/leaflet-routing-machine/dist/leaflet-routing-machine.css [client] (css) */
...
.leaflet-routing-icon {
  ...
  content: "";
  vertical-align: top;
  background-image: url("../media/leaflet.routing.icons.5e7170d6.png");
...
.leaflet-routing-container-hide .leaflet-routing-collapse-btn {
  background-image: url("../media/routing-icon.eeba7818.png");
  width: 26px;
  height: 23px;
  display: block;
  position: relative;
...
/*# sourceMappingURL=node_modules_leaflet-routing-machine_dist_leaflet-routing-machine_css_65f1660e._.single.css.map*/